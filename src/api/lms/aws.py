...
def main(file_name, userId):
    table_csv = get_table_csv_results(file_name, userId)

    # output_file1=(file_name.split('.')[0] + ".csv")
    
    # output_file = "D:/ocr/ocrapi/downloads/"+os.path.basename(output_file1)
    # # output_file = '/home/shra1/mywork/ocrAPI/node-express-server-rest-api/downloads/'+(output_file1.split('le/')[1])
